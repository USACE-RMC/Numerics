...
namespace Mathematics.Optimization
{
    ...
    {
        /// <summary>
        /// Test the Nelder-Mead algorithm with a simple 3-dimensional test function.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Test the Nelder-Mead algorithm with the De Jong Function in 5-D.
        /// </summary>
        [TestMethod]
        public void Test_DeJong()
        {
            ...
            var solver = new NelderMead(TestFunctions.DeJong, 5, initial, lower, upper);
            solver.Minimize();
            double F = solver.BestParameterSet.Fitness;
            double trueF = 0.0;
            Assert.AreEqual(F, trueF, 1E-4);
        ...
        /// <summary>
        /// Test the Nelder-Mead algorithm with the Sum of Power functions in 3-D.
        /// </summary>
        [TestMethod]
        public void Test_SumOfPowerFunctions()
        {
            ...
            var upper = new double[] { 1d, 1d, 1d };
            var solver = new NelderMead(TestFunctions.SumOfPowerFunctions, 3, initial, lower, upper);
            solver.Minimize();
            double F = solver.BestParameterSet.Fitness;
            double trueF = 0.0;
            Assert.AreEqual(F, trueF, 1E-4);
        ...
        /// <summary>
        /// Test the Nelder-Mead algorithm with the Rosenbrock Function in 2-D.
        /// </summary>
        [TestMethod]
        public void Test_Rosenbrock()
        {
            ...
            var solver = new NelderMead(TestFunctions.Rosenbrock, 2, initial, lower, upper);
            solver.Minimize();
            double F = solver.BestParameterSet.Fitness;
            double trueF = 0.0;
            Assert.AreEqual(F, trueF, 1E-4);
        ...
        /// <summary>
        /// Test the Nelder-Mead algorithm with the Beale Function
        /// </summary>
        [TestMethod]
