...
{
    /// <summary>
    /// Unit tests for the No-U-Turn Sampler (NUTS).
    /// </summary>
    /// <remarks>
    /// <para>
    ///     <b> Authors: </b>
    ...
    /// </para>
    /// <para>
    /// Reference values verified against RStan NUTS results for the Tippecanoe River dataset.
    /// </para>
    /// </remarks>
    [TestClass]
    public class Test_NUTS
    {
        ...
        /// <summary>
        /// This test compares the results obtained using NUTS for the Normal distribution with those from the 'rstan' package. 
        /// </summary>
        [TestMethod]
        public void Test_NUTS_NormalDist_RStan()
        {
            ...
            var sampler = new NUTS(priors, logLH);
            sampler.Sample();
        ...
        /// <summary>
        /// This test compares the results obtained using NUTS for the Logistic distribution with those from the 'rstan' package. 
        /// </summary>
        [TestMethod]
        public void Test_NUTS_LogisticDist_RStan()
        {
        ...
        /// <summary>
        /// This test compares the results obtained using NUTS for the Gumbel distribution with those from the 'rstan' package. 
        /// </summary>
        [TestMethod]
        public void Test_NUTS_GumbelDist_RStan()
        {
