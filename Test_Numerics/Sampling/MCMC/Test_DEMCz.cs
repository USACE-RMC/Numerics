...
{
    /// <summary>
    /// Unit test for the Differential Evolution Monte Carlo (DEMCz) sampler. 
    /// </summary>
    /// <remarks>
    /// <para>
    ///     <b> Authors: </b>
    ...
    public class Test_DEMCz
    {
        ...
        /// <summary>
        /// This test compares the results obtained using DEMCz for the Normal distribution with those from the 'rstan' package. 
        /// </summary>
        [TestMethod]
        public void Test_DEMCz_NormalDist_RStan()
        {
            ...
            var sampler = new DEMCz(priors, logLH);
            sampler.Sample();
        ...
        /// <summary>
        /// This test compares the results obtained using DEMCz for the Logistic distribution with those from the 'rstan' package. 
        /// </summary>
        [TestMethod]
        public void Test_DEMCz_LogisticDist_RStan()
        {
        ...
        /// <summary>
        /// This test compares the results obtained using DEMCz for the Gumbel distribution with those from the 'rstan' package. 
        /// </summary>
        [TestMethod]
        public void Test_DEMCz_GumbelDist_RStan()
        {
        ...
        /// <summary>
        /// This test compares the results obtained using DEMCz for the Weibull distribution with those from the 'rstan' package. 
        /// </summary>
        [TestMethod]
        public void Test_DEMCz_WeibullDist_RStan()
        {
