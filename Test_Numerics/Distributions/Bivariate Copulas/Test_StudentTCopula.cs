...
namespace Distributions.BivariateCopulas
{
    ...
    public class Test_StudentTCopula
    {
        ...
        public void Test_Clone()
        {
            ...
            var withMarginals = new StudentTCopula(0.5, 10, new Normal(100, 10), new Gumbel(50, 5));
            var marginalClone = withMarginals.Clone() as StudentTCopula;
            Assert.IsNotNull(marginalClone);
            Assert.AreNotSame(withMarginals.MarginalDistributionX, marginalClone.MarginalDistributionX);
            Assert.AreNotSame(withMarginals.MarginalDistributionY, marginalClone.MarginalDistributionY);
            Assert.AreEqual(withMarginals.MarginalDistributionY.InverseCDF(0.9), marginalClone.MarginalDistributionY.InverseCDF(0.9));
        }
